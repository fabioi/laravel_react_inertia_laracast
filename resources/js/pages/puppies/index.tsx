...
export default function App({ puppies,likedPuppies, filters }: { puppies: PaginatedResponse<Puppy>; likedPuppies: Puppy[]; filters: Filters }) {
    return (
        <PageWrapper>
            <Container>
                <Header />
                <Main paginatedPuppies={puppies} likedPuppies={likedPuppies} filters={filters} />
            </Container>
        </PageWrapper>
    );
}

function Main({ paginatedPuppies, likedPuppies,  filters }: { paginatedPuppies: PaginatedResponse<Puppy>; likedPuppies: Puppy[], filters: Filters }) {
